    ...
    <body>
       ...
       <div class="header">
        ...
        <nav>
            ...
            <img src="images/shopping-cart-svg-png-icon-download-28.png" width="30px" height="30px">
        </div>
        <div class="row">
            <div class="col-2">
                <h1>Clothing Shop<br> Online</h1>
            ...
            <div class ="col-2">
                <img src="images/confidence-is-the-best-accessory.jpg">
              </div>
            </div>
        </div>
        </div>
<!-- START Footer -->
  <footer>
      <p><small>&copy; 2022-<?=date("Y")?> by 
          <a href="contact.php">Aymen Khaleefa</a>, All Rights Reserved ~ 
